...
namespace IO.Swagger.Api
{
    ...
    public partial class UserApi : IUserApi
    {
        ...
        public ApiResponse< AccessTokenResponse > RevokeRefreshTokenWithHttpInfo (string refreshToken)
        {
            ...
            var localVarPath = "/login/refreshToken/{refreshToken}";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new Dictionary<String, String>();
            var localVarHeaderParams = new Dictionary<String, String>(Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (refreshToken != null) localVarPathParams.Add("refreshToken", Configuration.ApiClient.ParameterToString(refreshToken)); // path parameter
